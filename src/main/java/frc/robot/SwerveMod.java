...
public class SwerveMod{
    ...
    public SwerveMod(int moduleNumber, SwerveModuleConstants moduleConstants)
    {
       ...
       int drivecanbusid = 0;
        ...
        /* Angle Motor Config */
        mAngleMotor = new SparkMax(drivecanbusid, moduleConstants.angleMotorID, MotorType.kBrushless);
        ...
        /* Drive Motor Config */
        mDriveMotor = new SparkMax(drivecanbusid, moduleConstants.driveMotorID,  MotorType.kBrushless);
    ...
    private void setAngle(SwerveModuleState desiredState) {
       if(Math.abs(desiredState.speed) <= (Constants.Swerve.maxSpeed * 0.01))
       {
